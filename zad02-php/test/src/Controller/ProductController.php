...
{
    #[Route('/getAll', name: 'app_product_index', methods: ['GET'])]
    ...
    #[Route('/add', name: 'app_product_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/get/{id}', name: 'app_product_show', methods: ['GET'])]
    ...
    #[Route('/update/{id}', name: 'app_product_edit', methods: ['GET', 'POST'])]
